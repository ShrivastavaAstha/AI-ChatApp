...
//   // Select/deselect users for collaborators
...
//         setProject({ ...fetchedProject, users: fetchedProject.users || [] });
...
//       return alert("Project is empty!");

//     try {
//       await webContainer.mount(fileTree);

//       // Check if Node/React project
...
//         setIframeUrl(webContainer.url); // default URL for React/Node
//       } else {
//         // Static HTML project
//         const mainHtml = Object.keys(fileTree).find((f) =>
//           f.toLowerCase().endsWith(".html")
//         );
//         if (mainHtml) setIframeUrl(webContainer.url + "/" + mainHtml);
//         else alert("No HTML file found to run.");
//       }
//     } catch (err) {
